...
RefNest is a cross-platform desktop reference management application built with:
...
src/
  ...
  preload/       -- contextBridge API surface (window.refnest)
...
- Renderer never accesses Node.js APIs directly — only via `window.refnest.*`
