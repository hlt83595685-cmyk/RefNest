...
;(async () => {
  ...
  function setStatus(online) {
    ...
    statusLabel.textContent = online ? 'RefNest 已连接' : 'RefNest 未运行'
  }
  ...
  if (!ping?.online) {
    showError('请先启动 RefNest 桌面应用（端口 23119）')
    return
  }
  ...
  body.innerHTML = `
    ...
    <button id="saveBtn" class="btn btn-primary">保存到 RefNest</button>
  `
